...
urlpatterns = [
    ...
    url(r'^predict_ddos_attack_type/$', remoteuser.predict_ddos_attack_type, name="predict_ddos_attack_type"),
    ...
    url(r'^Find_View_Prediction_DDOS_Attack_Type_Ratio/$', serviceprovider.Find_View_Prediction_DDOS_Attack_Type_Ratio, name="Find_View_Prediction_DDOS_Attack_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Prediction_DDOS_Attack_Type/$', serviceprovider.View_Prediction_DDOS_Attack_Type, name="View_Prediction_DDOS_Attack_Type"),
